$( document ).ready(function() {
  ...
  $("#landing nav").css("opacity", 0);
  $("video").css("opacity", 0);
  $("header.landing").css("opacity", 0);
  $(".search_jobs").css("opacity", 0);
  $(".recent-searches").css("opacity", 0);
  $("#landing footer").css("opacity", 0);

  $(".assembly").transition({ opacity: 0, delay: 4000, easing: "out" }, 500);
  $(".video-overlay").transition({ opacity: 1, delay: 5000 }, 500);
  $("#landing nav").transition({ opacity: 1, delay: 6000 }, 500);
  ...
  $("header.landing").transition({ opacity: 1, delay: 7000, easing: "in" }, 500);
  $(".search_jobs").transition({ opacity: 1, delay: 7000 }, 500);
